...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        int mod = mod(hashCode, this.hashTable.length);
        this.hashTable[mod].add(key, value);
    }
    ...
    public final Pair<K, V> remove(K key) {
        ...
        return this.hashTable[location].remove(key);
    }
    ...
    public final Pair<K, V> removeAny() {
        ...
        int i = 0;
        while (!elementsFound) {
            elementsFound = this.hashTable[i].size() > 0;
            i++;
        }
    ...
    public final V value(K key) {
        ...
        return this.hashTable[location].value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        int i = 0;
        while (!isFound && i < this.hashTable.length) {
            isFound = this.hashTable[i].hasKey(key);
            i++;
        }
    ...
    public final int size() {
        ...
        int sumOfSizes = 0;
        for (Map<K, V> m : this.hashTable) {
            sumOfSizes = sumOfSizes + m.size();
        }
